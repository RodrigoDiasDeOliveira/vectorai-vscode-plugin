...
class EmbeddingCommand {
    ...
    getEmbedding(text) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const embedding = yield this.vectorService.getEmbedding(text); // Chama o método da VectorAIService
                if (!embedding) {
    ...
    register() {
        return vscode.commands.registerCommand('vectorai.generateEmbedding', () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.getEmbedding(selection); // Chama o novo método getEmbedding aqui
        }));
    }
}
